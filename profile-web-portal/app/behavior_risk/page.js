...
export default function CustomerRiskMonitor (){
  ...
  */
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 min-h-screen bg-[#09141f]">
      
      {/* Sidebar List with Pagination */}
      <div className="lg:col-span-1 bg-slate-900 border border-slate-800 rounded-lg flex flex-col overflow-hidden shadow-sm max-h-[95vh] mt-6 ml-4">
        <div className="p-4 border-b border-slate-800 space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-700 rounded pl-8 pr-2 py-2 text-sm focus:outline-none focus:border-blue-500 text-slate-100 placeholder-slate-500"
              value={filterText}
          ...
          {sortedCustomers.map(customer => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <span className="font-medium text-slate-200 truncate">{customer.Full_Name}</span>
              ...
              <div className="flex gap-2">
                ...
                )}
                {
                  customer.REASON_CODES_JSON.includes("Zombie Account") && (
                    <span className="text-[10px] bg-purple-900/50 text-purple-300 border border-purple-800 px-1.5 py-0.5 rounded flex items-center gap-1">
        ...
        <div className="p-4 border-t border-slate-800 flex justify-between items-center">
          <button
            ...
            className="px-3 py-1 text-sm rounded border border-slate-700 bg-slate-950 text-slate-300 disabled:opacity-50 transition-colors hover:bg-slate-800"
          >
            Previous
          </button>
      ...
      {/* Main Dashboard */}
      <div className="lg:col-span-3 space-y-6 overflow-auto pr-2 max-h-screen p-6">
        {selectedCustomer && (
          <>
            {/* Header Card */}
            <div className="bg-slate-900 border border-slate-800 rounded-lg p-6 shadow-sm">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="text-right">
                  <div className="text-sm text-slate-400 mb-1">Composite Risk Score</div>
                  <div className={`text-3xl font-bold font-mono ${
                    selectedCustomer.RISK_SCORE > 80 ? 'text-red-500' : 
                    selectedCustomer.RISK_SCORE > 50 ? 'text-orange-500' : 'text-green-500'
                  }`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-lg p-5 shadow-sm">
                ...
                <div className="mt-2 text-xs text-slate-400 bg-slate-950 p-2 rounded">
                  Analysis: Customer transaction value deviates by <span className="text-red-400 font-bold">
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-lg p-5 shadow-sm">
                ...
                <div className="flex items-center justify-center h-48 relative">
                   <div className="relative w-32 h-32">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center flex-col">
                        <span className="text-2xl font-bold text-white">{(selectedCustomer.KYC_INTEGRITY_COMPLETENESS_RATIO * 100).toFixed(0)}%</span>
                ...
                <div className="grid grid-cols-2 gap-2 mt-4 text-xs">
                   ...
                   <div className="flex justify-between p-2 bg-slate-950 rounded">
                      ...
                      <span className={selectedCustomer.KYC_INTEGRITY_COMPLETENESS_RATIO > 0.85 ? "text-green-400" : "text-yellow-400"}>
                   ...
                   <div className="flex justify-between p-2 bg-slate-950 rounded">
                      ...
                      <span className="text-green-400">{selectedCustomer.KYC_INTEGRITY_UNIQUENESS.fullname_matches}</span>
                   </div>
                   <div className="flex justify-between p-2 bg-slate-950 rounded">
                      <span className="text-slate-500">ID Match</span>
                      <span className="text-slate-200">{selectedCustomer.KYC_INTEGRITY_UNIQUENESS.idcard_matches}</span>
                   </div>
                </div>
              </div>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-lg p-5 shadow-sm relative overflow-hidden">
                ...
                {selectedCustomer.SANCTION_HITS.account_sanction_hit ? (
                  <div className="h-full flex flex-col justify-center items-center text-center z-10 relative pb-10">
                     ...
                     <p className="text-sm text-red-300 mt-2">Customers appears on Sanction and Watch List</p>
                  ...
                  <div className="h-full flex flex-col justify-center items-center text-center pb-10">
                     ...
                     <p className="text-sm text-slate-400 mt-2">No matches found in our databases.</p>
