...
### `POST /sar-reports`
Submit a new Suspicious Activity Report to the database.

**Request body:**
```json
{
  "account_number": "1000100000001",
  "account_holder_name": "John Doe",
  "risk_score": 73.5,
  "risk_level": "HIGH",
  "suspicion_type": "structuring",
  "findings": "Account shows pattern of just-below-threshold transactions...",
  "risk_breakdown": [
    {"name": "irregular amount", "value": 0.45, "contribution": 22.5}
  ],
  "transaction_stats": {
    "sent_total": 121149,
    "cash_count_ratio": 0.65
  },
  "reported_at": "2026-05-14T10:30:00Z"
}
```
...
```json
{
  "success": true,
  "sar_id": 123,
  "created_at": "2026-05-14T10:30:15.234Z",
  "message": "SAR submitted successfully"
}
```

The endpoint automatically creates the `sar_reports` table if it doesn't exist.

---

### `GET /sar-reports`
Retrieve all submitted SAR reports with pagination and filtering.
...
| `account_number` | string | Filter by specific account |
...
# Get high-risk SARs only
GET /sar-reports?risk_level=HIGH

# Get SARs for a specific account
GET /sar-reports?account_number=1000100000001
```
